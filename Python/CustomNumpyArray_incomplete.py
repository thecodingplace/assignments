...
# If you need a reference, a correct implemntation of the functions can be found here: https://raw.githubusercontent.com/thecodingplace/assignments/main/Python/CustomNumpyArray.py
...
code = pygrab.get('https://raw.githubusercontent.com/thecodingplace/assignments/main/Python/CustomNumpyArray.py').text
